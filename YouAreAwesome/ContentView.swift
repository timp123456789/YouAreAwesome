        ...
        VStack {
            ...
            HStack{
                ...
                Button("Press Me!") {
                    ...
                    lastMessageNum = nonRepeatingRandom(lastNumber: lastMessageNum, upperBound: message1.count-1)
                    ...
                    //                var audioNumber: Int
                    //                repeat {audioNumber = Int.random(in: 0...(numberofAudios-1))
                    //                } while audioNumber == lastAudioNum
                    //                lastAudioNum = audioNumber
                    //
                    //
                    //                let soundName = "sound\(audioNumber)"
                    //
